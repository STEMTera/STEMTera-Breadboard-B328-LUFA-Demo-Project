...
/** \file
 *  \brief Board specific information header for the STEMTera.
 *  \copydetails Group_BoardInfo_STEMTERA
 *
 ...
 *  \defgroup Group_BoardInfo_STEMTERA STEMTERA
 *  \brief Board specific information header for the STEMTERA.
 *
 *  Board specific information header for the STEMTERA.
 *
 *  @{
 */

#ifndef __BOARD_STEMTERA_H__
#define __BOARD_STEMTERA_H__
